//Middleware – это некий промежуточный слой между клиентом и сервером
//перехватывает необработанные исключения, произошедшие во время обработки запроса, и генерирует стандартизированный JSON-ответ об ошибке.
...
namespace abulbarovakt_31_22.Middlewares
{
